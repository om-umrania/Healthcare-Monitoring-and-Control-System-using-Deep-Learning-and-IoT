...
param_columns_general = ['T1', 'T2', 'Text1', 'Text2']
param_columns_covid = ['T1', 'T2', 'O1', 'O2', 'Text1', 'Text2']
param_columns_heart = ['ECG_temp', 'ECG_temp', 'BP_temp', 'BP_temp', 'Text1', 'Text2', 'H1', 'H2']
param_columns_diabetes = ['GL1', 'GL2', 'O1', 'O2', 'Text1', 'Text2', 'H1', 'H2']

# Execute the algorithm for each case with synthetic data
print("The best solution for each case with synthetic data is:")
print()
